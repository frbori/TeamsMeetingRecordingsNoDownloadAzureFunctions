...
The already defined schedule is each day at 6:00 AM UTC (file [function.json](https://github.com/frbori/TeamsMeetingRecordingsNoDownloadAzureFunctions/blob/master/addteamsinqueue/function.json)).
